<%--<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OpenlayersExProj._Default" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" %>

<!DOCTYPE html>
<html>
<head>
    <title>Openlayers Example Application</title>
    ...
    <form id="options-form" automplete="off">
        <table class="table">
            <tbody>
                <tr>
                    <th scope="row">
                        <input type="button" value="SEARCH" id="searchButton" /></th>
                    <td>
                        <input type="radio" name="interaction" value="drawDistrict" id="drawDistrict">Draw District</td>
                    <td>
                        <input type="radio" name="interaction" value="markPlace" id="markPlace">Mark Place</td>
                    <td>
                        <input type="radio" name="interaction" value="select" checked>Select</td>
                </tr>
            </tbody>
        </table>
    </form>
